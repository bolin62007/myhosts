...
#then                                                                            
  wget -q https://raw.githubusercontent.com/OHLIA/myhosts/master/Go-hosts -O /root/1quicklink/myhosts/1go.hosts --no-check-certificate
  ...
  wget -q https://raw.githubusercontent.com/OHLIA/myhosts/master/other-hosts -O /root/1quicklink/myhosts/3other.hosts --no-check-certificate
